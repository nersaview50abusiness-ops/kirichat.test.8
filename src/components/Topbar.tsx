    ...
    <header className="flex items-center justify-between w-full h-[68px] px-4 py-2 bg-white border-b border-[#e0e2e7]">
      ...
      <div className="flex items-center gap-3">
        <Button
          variant="ghost"
          size="icon"
          className="w-[34px] h-[34px] p-2 rounded-lg hover:bg-gray-100"
        >
          <img className="w-[18px] h-[18px]" alt="Messages" src="/svg.svg" />
        </Button>
        <Button
          variant="ghost"
          size="icon"
          className="w-[34px] h-[34px] p-2 rounded-lg hover:bg-gray-100"
        >
          <img className="w-[18px] h-[18px]" alt="Notifications" src="/svg-1.svg" />
        </Button>
